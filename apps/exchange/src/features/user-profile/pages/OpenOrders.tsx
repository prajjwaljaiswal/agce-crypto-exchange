...
import "./SpotOrders/spotOrders.css";
...
const OPEN_ORDER_ROWS = Array.from({ length: 8 }, (_, i) => ({
  id: i + 1,
  contract: "BTCUSDT",
  orderId: "26475839201",
...
export function OpenOrders({ pageTitle = "Open Orders", idPrefix = "oo" }: OpenOrdersProps) {
