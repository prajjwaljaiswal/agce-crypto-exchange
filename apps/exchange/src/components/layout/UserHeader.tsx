...
export function UserHeader() {
  ...
  return (
    <header className={`sticky-top${isAuthenticated ? ' afterloginheader' : ''}`}>
              ...
              <nav className="navbar navbar-expand-lg">
                ...
                >
                  <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    {isAuthenticated ? (
                      /* Home (logged in only — matches ref AuthHeader) */
              ...
              <div className="button_outer">
                ...
                {isAuthenticated ? (
                  <>
                    <button
                      type="button"
                      className="login_btn deposit-btn"
                      onClick={() => navigate('/asset_managemnet/deposit')}
                    >
              ...
              {isAuthenticated ? (
                <div className="icon_notificaton_r">
                  <ul>
                    ...
                    <li
                      className="wallet_tb"
                      onClick={() => navigate('/user_profile/asset_overview')}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="26"
                      ...
                      >
                        <path
                          d="M45.5575 25.9365H43.6845V24.0635C43.6845 20.973 40.875 19.381 38.0655 19.381H9.96954C6.22354 19.381 2.47754 17.1335 2.47754 12.8255C2.47754 8.51752 6.22354 6.27002 9.96954 6.27002H39.189C42.935 6.27002 45.5575 8.89252 45.5575 12.8255V17.508H43.6845V12.825C43.6845 9.92202 41.999 8.14252 39.189 8.14252H9.96954C7.16004 8.14252 4.35054 9.73452 4.35054 12.825C4.35054 15.9155 7.16004 17.5075 9.96954 17.5075H38.065C41.811 17.5075 45.557 19.755 45.557 24.063L45.5575 25.9365Z"
                          fill="currentColor"
                        />
                        <path
                          d="M39.002 43.7304H9.03304C5.00604 43.7304 2.47754 41.123 2.47754 36.97V12.825H4.35054V36.97C4.35054 40.0605 6.03604 41.799 9.03304 41.799H39.0015C41.811 41.799 43.684 39.8675 43.684 36.97V35.0385H45.557V36.97C45.5575 40.9295 42.8415 43.7304 39.002 43.7304Z"
                          fill="currentColor"
                        />
                        <path
                          d="M37.5969 10.0154H8.56494V11.8884H37.5969V10.0154Z"
                          fill="currentColor"
                        />
                        <path
                          d="M37.5969 13.7615H17.9299V15.6345H37.5969V13.7615Z"
                          fill="currentColor"
                        />
                        <path
                          d="M45.5576 36.2385H39.9386C36.8481 36.2385 34.3196 33.71 34.3196 30.6195C34.3196 27.5285 36.8481 25 39.9386 25H45.5576C47.1496 25 48.3671 26.2175 48.3671 27.8095V33.4285C48.3671 35.021 47.1496 36.2385 45.5576 36.2385ZM39.9386 26.873C37.8781 26.873 36.1926 28.5585 36.1926 30.619C36.1926 32.6795 37.8781 34.365 39.9386 34.365H45.5576C46.1196 34.365 46.4941 33.9905 46.4941 33.4285V27.8095C46.4941 27.2475 46.1196 26.873 45.5576 26.873H39.9386Z"
                          fill="currentColor"
                        />
                        <path
                          d="M40.8749 33.4286C39.2829 33.4286 38.0654 32.2111 38.0654 30.6191C38.0654 29.0271 39.2829 27.8096 40.8749 27.8096C42.4669 27.8096 43.6844 29.0271 43.6844 30.6191C43.6844 32.2111 42.4669 33.4286 40.8749 33.4286ZM40.8749 29.6826C40.3129 29.6826 39.9384 30.0571 39.9384 30.6191C39.9384 31.1811 40.3129 31.5556 40.8749 31.5556C41.4369 31.5556 41.8114 31.1811 41.8114 30.6191C41.8114 30.0571 41.4369 29.6826 40.8749 29.6826Z"
                          fill="currentColor"
                        />
                      </svg>
                      <div
                        className="wallet_profile_tab"
                        onClick={(e) => e.stopPropagation()}
                      >
                        <h3>
                          Total Assets
                          {showBalance ? (
                            <i
                              className="ri-eye-line mx-2"
                              onClick={() => setShowBalance(false)}
                            />
                          ) : (
                            <i
                              className="ri-eye-close-line mx-2"
                        ...
                        <ul className="ac_wallet_info">
                          <li>
                            <Link to="/user_profile/asset_overview">
                              Account
